  ...
  return (
    ...
    >
      ...
      >
        <animated.div
          style={trails[1]}
          className={`w-full h-full ${colors.accent} border border-current`}
        ></animated.div>
      </animated.div>
      ...
      >
        <animated.div
          style={trails[3]}
          className={`w-full h-full relative ${colors.primary} border border-current`}
        ></animated.div>
      </animated.div>
      ...
      >
        <animated.div
          style={trails[4]}
          className={`w-full h-full lg:flex justify-between items-center p-10 gap-5 ${colors.accent} border border-current`}
        ></animated.div>
      </animated.div>
    </animated.div>
  );
